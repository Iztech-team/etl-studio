...
export default function LiquidEther({
  ...
  gl_Position = vec4(pos, 1.0);
    ...
    class Advection extends ShaderPass {
      ...
      update({ dt: _dt, isBounce: _isBounce, BFECC: _BFECC }: any) {
        this.uniforms.dt.value = _dt;
        this.line.visible = _isBounce;
        this.uniforms.isBFECC.value = _BFECC;
        super.update();
      }
    }
    ...
    class Viscous extends ShaderPass {
      ...
      update({ viscous: _viscous, iterations, dt: _dt }: any) {
        let fbo_in, fbo_out;
        this.uniforms.v.value = _viscous;
    ...
    class Pressure extends ShaderPass {
      ...
      update({ vel, pressure: _pressure }: any) {
        this.uniforms.velocity.value = vel.texture;
        this.uniforms.pressure.value = _pressure.texture;
        super.update();
      }
    }
